...
## 📅 Fecha: 2024
## 🎯 Objetivo: Añadir sistema de comandos remotos y reinicio de balizas desde el panel web
...
- Envía comando personalizado a una baliza específica
...
- **⚠️ REINICIA EL SISTEMA WINDOWS COMPLETO** del ordenador de la baliza
...
#### ✅ `restartAllBeacons()`
- **⚠️ REINICIA TODOS LOS SISTEMAS WINDOWS** de todas las balizas
...
```
┌──────────────┐     ┌───────────┐     ┌──────────┐     ┌────────────┐
│  Panel Web   │ --> │ Firestore │ --> │ WPF App  │ --> │   Baliza   │
